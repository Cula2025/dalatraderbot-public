...
if files:
    ...
    if profiles:
        ...
        if st.sidebar.button("Använd vald profil", type="primary", use_container_width=True):
...
if col_run.button("Kör backtest", type="primary", use_container_width=True):
...
if col_save.button("Spara som TMP", use_container_width=True):
    try:
